  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_comment as @admin_comment" do
        ...
        post :create, {:admin_comment => { "content" => "invalid value" }}, valid_session
        assigns(:admin_comment).should be_a_new(Admin::Comment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_comment" do
        ...
        Admin::Comment.any_instance.should_receive(:update_attributes).with({ "content" => "MyString" })
        put :update, {:id => comment.to_param, :admin_comment => { "content" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_comment as @admin_comment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::Comment.any_instance.stub(:save).and_return(false)
        put :update, {:id => comment.to_param, :admin_comment => { "content" => "invalid value" }}, valid_session
        assigns(:admin_comment).should eq(comment)
      end
